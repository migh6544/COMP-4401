...
def main():
    ...
    car1 = Car("Red", 2022, "Toyota", "Camry", 4, "gas", 120.5, 30.0)
    car2 = Car("Blue", 2021, "Honda", "Civic", 4, "electric", 110.0, 35.0)

    # Printing Car information
    print(car1.carInfo())  # Expected: Toyota - Camry - Red
    print(car2.carInfo())  # Expected: Honda - Civic - Blue

    # Change color of car1
    car1.changeColor("Yellow")
    print(car1.carInfo())  # Expected: Toyota - Camry - Yellow

    # Compare gas mileage
    better_mileage_car = car1.betterGasMileage(car1, car2)
    # Expected: Honda - Civic - Blue
    print(f"The car with better gas mileage is: {better_mileage_car}")

    # Get the total number of Car instances created
    total_cars = Car.num_cars
    # Expected: 2
    print(f"Total number of Car instances created: {total_cars}")
